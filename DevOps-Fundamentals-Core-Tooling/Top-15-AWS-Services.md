...
**Lambda:** A serverless compute service used for executing short, event-driven actions, often in conjunction with CloudWatch, for tasks like encrypting unencrypted volumes (15:38).
